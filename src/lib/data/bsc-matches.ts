...
/** Partidos BSC 2026 — Brawl Cup completo + Monthly Finals clave (Liquipedia) */
export const bscMatches: EsportsMatch[] = [
  // ── Brawl Cup 2026 — Group A ──
  ...
  // ── March 2026 Monthly Finals ──
  { id: "mf26-mar-emea-gf", teamASlug: "fut-esports", teamBSlug: "hmble", scoreA: 3, scoreB: 2, tournamentSlug: "bsc-2026-march-emea-mf", stage: "Grand Final", date: "2026-03-15T15:00:00Z", status: "finished", region: "EMEA", format: "Bo5" },
