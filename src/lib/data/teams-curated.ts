...
> = {
  ...
  "novo-esports": { rank: 18, roster: ["filippo", "meow", "terry"] },
...
> = {
  ...
  patchy: { teamSlug: "only-realm", fantasyPoints: 78, fantasyOwnership: 33, rating: 1.09 },
  rafiki: { teamSlug: "legacy-esports", fantasyPoints: 77, fantasyOwnership: 60, rating: 1.24 },
  zoulan: { teamSlug: "legacy-esports", fantasyPoints: 62, fantasyOwnership: 72, rating: 1.23 },
  zeus: { teamSlug: "legacy-esports", fantasyPoints: 62, fantasyOwnership: 15, rating: 1.23 },
  ducky: { teamSlug: "f-a-homeless", fantasyPoints: 96, fantasyOwnership: 62, rating: 1.12 },
  tyrant: { teamSlug: "f-a-homeless" },
  xemp: { teamSlug: "f-a-homeless" },
  belal: { teamSlug: "vatic-esports", fantasyPoints: 77, fantasyOwnership: 60, rating: 1.24 },
  ezlivi: { teamSlug: "vatic-esports" },
  rup: { teamSlug: "madridmira" },
  yoko: { teamSlug: "madridmira" },
  jusorange: { teamSlug: "madridmira" },
